      ...
      <main className="flex-1 overflow-hidden flex relative">
        ...
        {activeTab === 'study' && (
          <PanelGroup orientation="horizontal" id="theologica-layout-v2" className="flex w-full h-full">
            ...
            {showLeftSidebar && (
              <Panel defaultSize={25} minSize={25} className={`w-full lg:w-auto border-r border-[#30302e] bg-[#141413] flex-col ${mobileStudyView === 'chapters' ? 'flex' : 'hidden lg:flex'}`}>
            ...
            <Panel defaultSize={45} minSize={15} className={`w-full lg:w-auto flex-col h-full bg-[#141413] ${mobileStudyView === 'reader' ? 'flex' : 'hidden lg:flex'}`}>
              ...
              {/* Quick Note Split */}
                {showBottomNotes && (
                  <Panel defaultSize={25} minSize={25} className="border-t border-[#30302e] bg-[#141413] flex flex-col shrink-0">
            ...
            {showRightSidebar && (
              <Panel defaultSize={30} minSize={30} className={`w-full lg:w-auto border-l border-[#30302e] bg-[#141413] flex-col ${mobileStudyView === 'ai' ? 'flex' : 'hidden lg:flex'}`}>
