      ...
      <main className="flex-1 overflow-hidden flex relative">
        ...
        {activeTab === 'study' && (
          <PanelGroup orientation="horizontal" id="theologica-layout-v2" className="flex w-full h-full">
            ...
            {showLeftSidebar && (
              <Panel panelRef={leftPanelRef} defaultSize="15" minSize="15" className={`max-lg:!flex-none max-lg:!w-full max-lg:!min-w-full max-lg:!h-full max-lg:!min-h-full w-full lg:w-auto border-r border-[#30302e] bg-[#141413] flex-col ${mobileStudyView === 'chapters' ? 'flex' : 'hidden lg:flex'}`}>
            ...
            {/* Center: Bible Reader */}
            <Panel defaultSize="60" minSize="30" className={`max-lg:!flex-none max-lg:!w-full max-lg:!min-w-full max-lg:!h-full max-lg:!min-h-full w-full lg:w-auto flex-col h-full bg-[#141413] ${mobileStudyView === 'reader' ? 'flex' : 'hidden lg:flex'}`}>
              <PanelGroup orientation="vertical" id="theologica-layout-vertical-v2">
                <Panel defaultSize="75" minSize="30" className="max-lg:!flex-none max-lg:!w-full max-lg:!min-w-full max-lg:!h-full max-lg:!min-h-full flex flex-col relative">
            ...
            {showRightSidebar && (
              <Panel panelRef={rightPanelRef} defaultSize="25" minSize="20" className={`max-lg:!flex-none max-lg:!w-full max-lg:!min-w-full max-lg:!h-full max-lg:!min-h-full w-full lg:w-auto border-l border-[#30302e] bg-[#141413] flex-col ${mobileStudyView === 'ai' ? 'flex' : 'hidden lg:flex'}`}>
